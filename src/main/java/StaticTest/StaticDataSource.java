...
public class StaticDataSource {
    public static Dish getPlatsTest() {
        ...
        DishIngredient oeufs = new DishIngredient(oeuf, 1, Unit.U);
        DishIngredient pains = new DishIngredient(pain, 1, Unit.U);

        List<DishIngredient> ingredientsHotDog = new ArrayList<>(Arrays.asList(saucisses, huiles, oeufs, pains));

        Dish hotDog = new Dish(1, "Hot dog", 15000, ingredientsHotDog);
